...
import com.webwoz.wizard.server.components.MToutDefault;
//import com.webwoz.wizard.server.components.MToutGoogle;
import com.webwoz.wizard.server.components.MToutMicrosoft;

public class MToutComp implements Component {

	// variables
	private final int type = 5;
	private final String typeName = "MT(out)";
	private String name;
	private int mode;
	...
	public Component getComponent(int comp, int mode) {
		...
		switch (comp) {
		case 0:
			return new MToutDefault(mode);
		case 1:
			return new MToutMicrosoft(mode);
		case 2:
