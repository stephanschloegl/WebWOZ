...
public class SettingsMTout implements Screen {
	...
	public SettingsMTout(int exp, String path, String ss, String mts,
		...
		compList.addChangeHandler(new ChangeHandler() {
			public void onChange(ChangeEvent event) {
				changeComponent(Integer.parseInt(compList.getValue(compList
						.getSelectedIndex())));
			}
	...
	private void changeComponent(final int comp) {
		String sql = "Update experimentcomponent set component = " + comp
				+ " where id = " + compID;
		...
		AsyncCallback<String> callback = new AsyncCallback<String>() {
			...
			public void onSuccess(String result) {
				...
				if (comp > 0) {
					WebWOZWizard.changeVisiblility(6);
				} else {
					WebWOZWizard.changeVisiblility(7);
				}
				reloadSettings();
